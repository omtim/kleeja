...
*
* @package adm
* @version $Id: index.php 2240 2013-12-07 23:22:54Z phpfalcon@gmail.com $
...
#check messages and reports numbers
...
foreach(array('messages'=>'messages', 'reports'=>'reports') as $table=>$n)
{
	$query	= array(
...
{
	$SQL->close();
	exit($kbubbles['messages'] . '::' . $kbubbles['reports']);
}
